...
//Задание 1
alert("Рейтинг выводится под кнопками, записываю после каждого раза, как кушаем еду через innerHTML статистику");
//Задание 2
alert("На поле геренируется припятствие фиолетового цвета, попав в которое игра заканчивается. Можно также настроить скорость формирования припятствия. Объект barrier");
//Задание 3
alert("Сейчас функция полностью корректно работает если идти вправо или вниз. Вверх и влево есть проблемы, но крашится всё не полностью, исправить думаю легко. На момент, когда вывсылаю ДЗ уже час ночи и хочу спать)");
