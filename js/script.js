...
//Задание 1
alert("Слайдер находится в пути /slider. Повесил ивент листенер на изображение (error). Когда ивент задействуется, ставим другую картинку, а также загоняю id картинки в массив errorImgs. Сейчас это не несет за собой смысла, но я это сделал, как пример того, что можно с имеющимися данными рабоатать как угодно");
//Задание 2
alert("Задание находится находится в пути /basket. Всё что требовалось реализовано. Товар генерируется, товар добавляется в корзину");
//Задание 3
alert("В галлерее уже была функция преключения между слайдами");
