...
sliderImg.addEventListener("error", function(){
  images.errorImgs.push(images.currentIdx);
  sliderImg.setAttribute("src", "http://zabolotskikh.com/wp-content/uploads/2016/07/computer-159320_960_7201-850x425.png");
});
